...
// data.json
// Đang hiển thị data.json.
export default class EXRenderProductList extends Component {
    render() {
        /*
       Props là gì ?
        props là thuộc tính có sẵn của react class component dùng để nhận giá trị từ nơi sử dụng thẻ component này truyền vào (Component cha truyền vào )
         Props khác state?
