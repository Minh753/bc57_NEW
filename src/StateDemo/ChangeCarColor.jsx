    ...
    render() {
        return (
            <div className='container'>
                ...
                <div className="col-6">
                    <button className='btn btn-danger' onClick={() => { this.changeColor('red') }}>Red</button>
                    <button className='btn btn-dark mx-2' onClick={() => { this.changeColor('black') }}>Black</button>
                    <button className='btn btn-default mx-2' onClick={() => { this.changeColor('silver') }}>Silver</button>
                    <button className='btn btn-secondary' onClick={() => { this.changeColor('steel') }}>Steel</button>
                </div>
            </div>
        )
    }
