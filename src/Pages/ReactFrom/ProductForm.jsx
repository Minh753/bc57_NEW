                    ...
                    <div className="row">
                        <div className="col-6">
                            <div className="mb-3">
                                ...
                                <input value={id} data-type="number" type="text" className="form-control" id="id" name="id" onInput={this.handleChangeInput} />
                                <p className='text text-danger'>{this.state.errors.id}</p>
                            </div>
                            <div className="mb-3">
                                <label htmlFor="name">Name:</label>
                                <input value={name} type="text" className="form-control" id="name" name="name" onInput={this.handleChangeInput} />
                        ...
                        <div className="col-6">
                            <div className="mb-3">
                                ...
                                <input value={img} type="text" className="form-control" id="img" name="img" onInput={this.handleChangeInput} />
